// --- Debug Script for delucru.md ---
console.log("Highlighting job links and pagination on delucru.md");

// Selector for job links based on config
const jobLinkSelector = 'a.link-job';
...
if (currentUrl.includes('page=')) {
    ...
    firstPageUrl = 'https://www.delucru.md/jobs?page=1';
...
window.removeDELUCRU_MDHighlights = function() {
    jobLinks.forEach(removeHighlight);
    paginationLinks.forEach(removeHighlight);
    console.log("Highlights removed for delucru.md.");
};

console.log("Highlighting complete. Check the console for counts and the potential first page URL. Run removeDELUCRU_MDHighlights() to remove highlights.");