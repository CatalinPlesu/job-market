...
const DatabaseSchema = {
    mainTable: {
        ...
        columns: [
            ...
            { name: 'title_id', type: 'INTEGER', description: 'Foreign key to titles table' },
            { name: 'job_function_id', type: 'INTEGER', description: 'Foreign key to job_functions table' },
            { name: 'seniority_level_id', type: 'INTEGER', description: 'Foreign key to seniority_levels table' },
            { name: 'industry_id', type: 'INTEGER', description: 'Foreign key to industries table' },
            { name: 'department_id', type: 'INTEGER', description: 'Foreign key to departments table' },
            { name: 'job_family_id', type: 'INTEGER', description: 'Foreign key to job_families table' },
            { name: 'specialization_id', type: 'INTEGER', description: 'Foreign key to specializations table' },
            ...
            { name: 'salary_currency_id', type: 'INTEGER', description: 'Foreign key to currencies table' },
            { name: 'salary_period_id', type: 'INTEGER', description: 'Foreign key to salary_periods table' },
            { name: 'required_education_id', type: 'INTEGER', description: 'Foreign key to education_levels table' },
            { name: 'experience_years', type: 'INTEGER', description: 'Required years of experience' },
            { name: 'employment_type_id', type: 'INTEGER', description: 'Foreign key to employment_types table' },
            { name: 'contract_type_id', type: 'INTEGER', description: 'Foreign key to contract_types table' },
            { name: 'work_schedule_id', type: 'INTEGER', description: 'Foreign key to work_schedules table' },
            { name: 'shift_details_id', type: 'INTEGER', description: 'Foreign key to shift_details table' },
            { name: 'remote_work_id', type: 'INTEGER', description: 'Foreign key to remote_work_options table' },
            { name: 'travel_required_id', type: 'INTEGER', description: 'Foreign key to travel_requirements table' },
            { name: 'city_id', type: 'INTEGER', description: 'Foreign key to cities table' },
            { name: 'region_id', type: 'INTEGER', description: 'Foreign key to regions table' },
            { name: 'country_id', type: 'INTEGER', description: 'Foreign key to countries table' },
            { name: 'full_address_id', type: 'INTEGER', description: 'Foreign key to full_addresses table' },
            { name: 'company_name_id', type: 'INTEGER', description: 'Foreign key to companies table' },
            { name: 'company_size_id', type: 'INTEGER', description: 'Foreign key to company_sizes table' },
            { name: 'contact_person_id', type: 'INTEGER', description: 'Foreign key to contact_persons table' },
